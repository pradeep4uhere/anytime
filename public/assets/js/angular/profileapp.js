var app = angular.module('prsProfileApp', ['ngRoute']).
constant('TOKEN',TOKEN).
constant('ADD_VENDOR_URL','API/webapi.php?action=addvendor&t='+ Math.random()+'&token='+TOKEN).
constant('UPDATE_VENDOR_PROFILE_URL','API/webapi.php?action=updatevendorprofile&t='+ Math.random()+'&token='+TOKEN).
constant('ALL_VENDOR_URL','API/webapi.php?action=allvendor&t='+ Math.random()+'&token='+TOKEN).
constant('EDIT_VENDOR_URL','API/webapi.php?action=editvendor&t='+ Math.random()+'&token='+TOKEN).
constant('DETAILS_VENDOR_URL','API/webapi.php?action=getvendorprofile&t='+ Math.random()+'&token='+TOKEN).
constant('ADD_SUPPLIER_URL','API/webapi.php?action=addsupplier&t='+ Math.random()+'&token='+TOKEN).
constant('EDIT_SUPPLIER_URL','API/webapi.php?action=editsupplier&t='+ Math.random()+'&token='+TOKEN).
constant('UPDATE_PWD_SUPPLIER_URL','API/webapi.php?action=updatepasswordsupplier&t='+ Math.random()+'&token='+TOKEN).
constant('ALL_SUPPLIER_URL','API/webapi.php?action=allsupplier&t='+ Math.random()+'&token='+TOKEN).
constant('ADD_CLIENT_URL','API/webapi.php?action=addclient&t='+ Math.random()+'&token='+TOKEN).
constant('DETAILS_SUPPLIER_URL','API/webapi.php?action=supplierdetails&t='+ Math.random()+'&token='+TOKEN).
constant('ALL_CLIENT_URL','API/webapi.php?action=allclientlist&t='+ Math.random()+'&token='+TOKEN).
constant('DETAILS_CLIENT_URL','API/webapi.php?action=allclientlist&t='+ Math.random()+'&token='+TOKEN).
constant('ADD_PRODUCT_URL','API/webapi.php?action=addproduct&t='+ Math.random()+'&token='+TOKEN).
constant('ALL_PRODUCT_URL','API/webapi.php?action=allproduct&t='+ Math.random()+'&token='+TOKEN).
constant('ALL_MASTER_LIST_URL','API/webapi.php?action=getlist&t='+ Math.random()+'&token='+TOKEN).
constant('GET_PRODUCT_URL','API/webapi.php?action=getproduct&t='+ Math.random()+'&token='+TOKEN);
